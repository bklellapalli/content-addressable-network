...
Client::Client(boost::asio::io_service& io_service, std::string& connectToAddr, std::string& connectToPort) : io_service(io_service), socket(io_service) , resolver(io_service)
{
